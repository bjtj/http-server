...
static void test_apply_properties() {
	...
	ASSERT(page.env().scope()->get_sym("*base-path*")->toPrintString(), ==, "/home/user/steve/");
	ASSERT(page.env().scope()->get_sym("*date-and-path-of-the-record*")->toPrintString(), ==, "2016-03-05 /home/user/");
}
