...
(defun anchor-browse (item) (format nil "<a href=\"~a?path=~a/~a\">~a</a>" (url "browse") *dir* item item))
(defun anchor-file (item) (format nil "<a href=\"~a?path=~a/~a\">~a</a>" (url "file") *dir* item item))
